...
> 🪦 **本仓库是 Macs Fan Control 时代的历史版本**（单按键 ⌃⌥⌘+8 在 Auto 和 Full Blast 之间切换）。
>
> 继承者已搬家到一个配套 [TG Pro](https://www.tunabellysoftware.com/tgpro/) 的新项目，支持多段折线风扇曲线、命名档位（Silence / Performance / Turbo）和快捷键循环切换（TG Pro 有合法 Apple Developer 签名的 SMC helper，在 Apple Silicon 上可用）。
>
> **👉 新安装请用 [tgpro-hotkey-mac](https://github.com/KrisWonka/tgpro-hotkey-mac)。**
>
> 本仓库保留作参考，Macs Fan Control 上还能用，但不会再更新。
